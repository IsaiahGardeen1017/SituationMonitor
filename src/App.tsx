...
function AlertStack(): ReactElement {
  const alerts = [
    ...
    ['Isreal Bombed!', '3m ago'],
    ['Iran Bombed!', '2m ago'],
    ['Webhook relay bounced', '11m ago'],
    ['Edge cache warming slower than target', '19m ago'],
    ['Cross-region replication paused', '24m ago'],
    ['Read model catch-up exceeded budget', '31m ago'],
    ['API token rotation still pending', '38m ago'],
  ]

  return (
    <div className="flex min-h-full flex-col gap-3 bg-slate-950 p-4">
